...
*/
        ...
        table.row().pad(20f);
        table.add().expand();
        table.add(title).colspan(4).expandX().fill();

        table.add().expand();


        table.row().padBottom(20f).padTop(20f);
        table.add().expand();
        table.add().expand();
        table.add(resumeB).expand().fillX().expand().colspan(2);
        table.add().expand();
        table.add().expand();
        ...
        table.add().expand();
        table.add().expand();
        table.add(restartB).expand().fillX().colspan(2);
        table.add().expand();
        table.add().expand();
        table.row().padTop(20f).padBottom(20f);
        table.add().expand();
        table.add().expand();
        table.add(music).expand().fillX().colspan(2);
        table.add().expand();
        table.add().expand();
        table.row().padTop(20f).padBottom(20f);
        table.add().expand();
        table.add().expand();
        table.add(quitB).expand().fillX().colspan(2);
        table.add().expand();
        table.add().expand();
        table.row().padTop(20f).padBottom(20f);
        table.add().expand();
